...
const MailtoLinkCreator = () => {
	...
	const validateMailchainAddress = (address) => {
		...
		const emojiAddressPattern = /^[a-zA-Z0-9\p{Emoji}]+(\.[a-zA-Z0-9\p{Emoji}]+)*@[a-zA-Z0-9]+\.mailchain\.com$/u;
		const ethereumAddressPattern = /^0x[a-fA-F0-9]{40}@ethereum\.mailchain\.com$/;
