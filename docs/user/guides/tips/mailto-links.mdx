...
**To: (required)** Enter the recipient's Mailchain address in the "To" field. Ensure it's a valid address. If the address is invalid, an error message will be displayed. For more information on addresses in Mailchain, please see [address formatting](/developer/address-formatting.md)
