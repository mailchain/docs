:::info
These steps may differ depending on the exact wallet you are using
:::
...
1.  You can now register wallet address with Mailchain.
    ...
    <img
    	...
    	alt="verify address"
    	src="/img/user/guides/getting-started/img-register-a-wallet/verify-address-walletconnect.png"
    />
...
1.  Click 'Confirm' (or 'Sign' depending on your wallet)

    <img
    	className="guides-image"
    	alt="review signature, then sign message"
    	src="/img/user/guides/getting-started/img-register-a-wallet/review-then-sign-walletconnect.png"
    />
