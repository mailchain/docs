1.  You can now register your wallet address with Mailchain.
    ...
    <img
    	...
    	alt="verify address"
    	src="/img/user/guides/getting-started/img-register-a-wallet/verify-address-coinbasewallet.png"
    />
...
1.  Click 'Sign'
    ...
    <img
    	...
    	src="/img/user/guides/getting-started/img-register-a-wallet/review-then-sign-coinbasewallet.png"
    />
