1.  You can now register your wallet address with Mailchain.
    ...
    <img
    	...
    	alt="verify address"
    	src="/img/user/guides/getting-started/img-register-a-wallet/verify-address-tezos.png"
    />
...
1.  Next, click 'Sign'
    ...
    <img
    	...
    	src="/img/user/guides/getting-started/img-register-a-wallet/review-then-sign-tezos.png"
    />
